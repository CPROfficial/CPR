...
export default function Suggestions() {
  ...
  return (
    <div className="space-y-4">
      {notification && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 border-4 border-green-400 p-4 text-center bg-green-900 bg-opacity-90 doom-badge-success shadow-lg animate-pulse">
          <div className="text-green-400 font-bold doom-glow text-2xl">{notification}</div>
        </div>
      )}
