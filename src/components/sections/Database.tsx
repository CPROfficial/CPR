    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="doom-panel-dark text-center">
          ...
          <div className="space-y-3">
            <div className="text-4xl font-bold text-green-400 doom-glow">
              {stats.totalTokens}
            </div>
      ...
      <div className="doom-panel-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border-2 border-gray-700 p-4 bg-black bg-opacity-40 hover:border-green-400 transition-all">
