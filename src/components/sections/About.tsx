  ...
  return (
    <div className="space-y-4">
      <div className="doom-panel-dark">
        ...
        <div className="space-y-4 text-gray-100">
          <p className="leading-relaxed text-lg">
            ▸ Computer Protocol Runner is an autonomous token generation and deployment system
        ...
        <div className="doom-panel-dark">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-gray-100 border-b-2 border-gray-700 pb-2 text-lg">
              <span>▸ AI Core:</span>
              <span className="text-green-400 font-bold doom-glow">Claude API</span>
            </div>
            <div className="flex justify-between text-gray-100 border-b-2 border-gray-700 pb-2 text-lg">
              <span>▸ Database:</span>
              <span className="text-green-400 font-bold doom-glow">PostgreSQL</span>
            </div>
            <div className="flex justify-between text-gray-100 border-b-2 border-gray-700 pb-2 text-lg">
              <span>▸ Deployment:</span>
              <span className="text-green-400 font-bold doom-glow">Pump.fun</span>
            </div>
            <div className="flex justify-between text-gray-100 border-b-2 border-gray-700 pb-2 text-lg">
              <span>▸ Theme:</span>
              <span className="text-green-400 font-bold doom-glow">Computer Science</span>
            </div>
      ...
      <div className="doom-panel-dark">
        ...
        <div className="space-y-4 text-gray-100">
          <p className="leading-relaxed text-lg">
            ▸ CPR operates as a self-directed agent in the token economy.
