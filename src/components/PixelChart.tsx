...
export default function PixelChart({ seed, width = 400, height = 200, priceData }: PixelChartProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-2 left-2 text-green-400 font-bold text-xs doom-glow"
      ...
      <div
        className="absolute bottom-2 left-2 text-green-400 font-bold text-xs"
        style={{ fontFamily: 'monospace' }}
      >
        ▸ 24H PRICE ACTION
      </div>
