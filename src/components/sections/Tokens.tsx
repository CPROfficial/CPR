  ...
  if (loading) {
    return (
      <div className="doom-panel-dark text-center py-12">
        <div className="text-green-400 font-bold doom-glow doom-blink text-xl">
        ...
        <div className="doom-panel-gray p-4">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <PixelLogo seed={selectedToken.logo_seed} size={96} imageUrl={(selectedToken as any).image_url} />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="doom-panel-dark border-4 border-yellow-300">
            ...
            <div className="text-center mb-3 pb-3 border-b-2 border-white">
              ...
              <div className="text-green-400 font-bold text-xl doom-glow">${tokenMetrics.priceInUsd}</div>
            </div>
            <div className="text-center">
              <div className="text-gray-300 text-sm mb-1">24H CHANGE</div>
              <div className={`font-bold text-2xl ${parseFloat(tokenMetrics.priceChange24h) >= 0 ? 'text-green-400 doom-glow' : 'text-red-400'}`}>
                {parseFloat(tokenMetrics.priceChange24h) >= 0 ? '+' : ''}{tokenMetrics.priceChange24h}%
              </div>
            </div>
          </div>

          <div className="doom-panel-dark border-4 border-green-400">
            <div className="text-center mb-3 pb-3 border-b-2 border-green-400">
              <div className="text-green-400 text-sm mb-1 doom-glow">MARKET CAP (SOL)</div>
              <div className="text-green-400 font-bold text-3xl doom-glow">{tokenMetrics.marketCapSol} ◎</div>
            </div>
            <div className="text-center mb-3 pb-3 border-b-2 border-white">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-400 font-bold text-xl">{tokenMetrics.volume24hSol} ◎</div>
            </div>
          </div>

          <div className="doom-panel-dark border-4 border-blue-400">
            <div className="text-center mb-3 pb-3 border-b-2 border-blue-400">
              <div className="text-blue-400 text-sm mb-1 doom-glow">LIQUIDITY (SOL)</div>
              <div className="text-blue-400 font-bold text-3xl doom-glow">{tokenMetrics.liquiditySol} ◎</div>
            </div>
            <div className="text-center mb-3 pb-3 border-b-2 border-white">
              <div className="text-gray-300 text-sm mb-1">HOLDERS</div>
              <div className="text-green-400 font-bold text-2xl doom-glow">{tokenMetrics.holders}</div>
            </div>
            <div className="text-center">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 pb-3 mb-3 border-b-2 border-yellow-300">
                <div className="flex-shrink-0">
                  <PixelLogo seed={token.logo_seed} size={56} imageUrl={(token as any).image_url} />
                </div>
              ...
              <div className="border-2 border-green-400 p-3 bg-black bg-opacity-70 mb-3">
                <div className="text-green-400 mb-2 font-bold text-center doom-glow">▸ MARKET CAP ▸</div>
                <div className="text-green-400 font-bold doom-glow text-2xl text-center">{marketCapSol} ◎</div>
