        ...
        <div className="flex-1 overflow-y-auto">
                ...
                <div className="border-2 border-white p-4 text-center bg-black bg-opacity-50">
                  ...
                  <div
                    className={`font-bold text-2xl ${
                      deploymentActive ? 'text-green-400 doom-glow doom-blink' : 'text-yellow-300 doom-glow'
                    }`}
                  >
          ...
          <div className="doom-panel-blue mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="border-2 border-green-400 p-3 bg-black bg-opacity-30">
                <div className="text-green-400 font-bold mb-3 text-center">▸ COMMUNITY & ACTIVITY ▸</div>
                ...
                tokens.map((token) => (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="text-green-400 font-bold doom-glow">
